namespace Halite2.hlt
{
	public class Constants
	{
		...
		/** Production that a docked ship produces */
		public static int BASE_PRODUCTION = 6;

		/** Production required to create a new ship */
		public static int PRODUCTION_PER_SHIP = 72;
		...
		public static int MAX_NAVIGATION_CORRECTIONS = 900;
