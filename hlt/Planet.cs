...
namespace Halite2.hlt
{
    public class Planet : Entity
    {
	    ...
	    public Position GetShipSpawnPosition(GameMap gameMap)
	    {
		    Position mapCenter = gameMap.GetCenter();
		    double fullDistance = mapCenter.GetDistanceTo(this);
		    double preferredDistance = this.GetRadius() + 2.23d;
		    Position spawnPosition = Position.Lerp(this, mapCenter, preferredDistance / fullDistance);
